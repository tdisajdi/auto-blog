...
def inject_images(html_text, t1, t2, mode):
    ...
    used_urls = set() 
    html_text = html_text.replace("[IMAGE_PLACEHOLDER_1]", get_image_tag(k1, used_urls, "바이오 관련 이미지 1"))
    html_text = html_text.replace("[IMAGE_PLACEHOLDER_2]", get_image_tag(k2, used_urls, "바이오 관련 이미지 2")) 
    return html_text
